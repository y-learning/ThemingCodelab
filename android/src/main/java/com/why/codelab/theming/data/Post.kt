...
package com.why.codelab.theming.data
...
private val post1 = Post(
    ...
    tags = hashSet("Modularization", "Gradle")
)
...
private val post5 = Post(
    ...
    tags = hashSet("Kotlin", "Collections", "Sequences")
)
...
interface PostGateway {
    fun getPosts(): PersistentList<Post>

    fun getFeaturedPost(): Post
}

object PostGatewayImp : PostGateway {
    override fun getPosts(): PersistentList<Post> = posts

    override fun getFeaturedPost(): Post = posts.random()
}
